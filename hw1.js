...
const Product = class Product {
    ...
    // `Product { `${product.name}',${product.price * .5},'${product.availability}` }`
    // [

        //arrNames[i], arrPrices[i], arrAvails[i]
    //     Product { name: 'Apple', price: 1, availability: 'In Stock' },
    //     Product { name: 'Carrot', price: 0.5, availability: 'Out of Stock' },
    //     Product { name: 'Bread', price: 3, availability: 'In Stock' },
    //     Product { name: 'Beef', price: 7, availability: 'Out of Stock' }
    //   ]
    // `Product: ${product.name}, Cost: ${new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(product.price)}, Availability: No`
    /**
     * *****************
     * ***** TODO ******
     * *****************
